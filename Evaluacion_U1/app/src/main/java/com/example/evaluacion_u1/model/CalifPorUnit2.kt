...
data class Envelope6 @JvmOverloads constructor(
    @field:Element(name = "Body", required = false)
    var body6: Body6 = Body6()
)
@Root(name = "Body", strict = false)
data class Body6 @JvmOverloads constructor(
    @field:Element(name = "getCalifUnidadesByAlumnoResponse", required = false)
    var getCalifUnidadesByAlumnoResponse: GetCalifUnidadesByAlumnoResponse2 = GetCalifUnidadesByAlumnoResponse2()
)

@Root(name = "getCalifUnidadesByAlumnoResponse", strict = false)
data class GetCalifUnidadesByAlumnoResponse2 @JvmOverloads constructor(
    @field:Element(name = "getCalifUnidadesByAlumnoResult", required = false)
    var getCalifUnidadesByAlumnoResult: String = ""
)

@Serializable
data class CalificacionPUnidad(
